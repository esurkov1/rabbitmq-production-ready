...
class MetricsCollector {
  ...
  recordConsume(queue, processingTime) {
    ...
    if (this.consume.minProcessingTime === null || processingTime < this.consume.minProcessingTime) {
      this.consume.minProcessingTime = processingTime;
    }

    if (this.consume.maxProcessingTime === null || processingTime > this.consume.maxProcessingTime) {
